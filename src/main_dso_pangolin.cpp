...
int main(int argc, char** argv) {
  ...
  if (source.find("vkitti") != std::string::npos) {
    left_dir = "Camera_0";
    right_dir = "Camera_1";
  } else if (source.find("kitti") != std::string::npos) {
    left_dir = "image_0";
    right_dir = "image_1";
  ...
  ImageFolderReader* reader = new ImageFolderReader(
      source + "/" + left_dir, calib, gammaCalib, vignette);
  ImageFolderReader* reader_right = new ImageFolderReader(
      source + "/" + right_dir, calib, gammaCalib, vignette);
